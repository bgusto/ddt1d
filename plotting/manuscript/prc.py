...
base = y.mean()                                            # no-skill precision = prevalence

fig, ax = plt.subplots(figsize=(5.2, 5.0))
ax.axhline(base, color="0.5", ls="--", lw=1.6)             # no-skill baseline
ax.plot(rec, prec, color="k", solid_joinstyle="round")
ax.set_xlim(0, 1)
ax.set_ylim(0, 1.02)
